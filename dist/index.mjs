var metadata = [
	...
	},
	{
		...
		unRegion: {
			...
			slug: "asia-and-the-middle-east",
			translations: {
				en: "Asia and the Middle East",
				de: "Asien",
				es: "Asia y Medio Oriente",
				pt: "Ásia e Oriente Médio",
				fa: "آسیا",
				fr: "Asie",
				it: "Asia",
				ja: "アジア・中東",
	...
	},
	{
		...
		unRegion: {
			...
			translations: {
				...
				de: "Lateinamerika und die Karibik",
				es: "América Latina y el Caribe",
				pt: "América Latina e Caribe",
				fa: "آمریکای لاتین و کارائیب",
				fr: "Amérique latine et Caraïbes",
				it: "America Latina e Caraibi",
				ja: "中南米とカリブ海地域",
				zh: "拉丁美洲和加勒比"
			}
		},
	...
	},
	{
		...
		slug: "heard-island-and-mc-donald-islands",
		translations: {
			de: "Heard und McDonaldinseln",
			en: "Heard Island and McDonald Islands",
			es: "Islas Heard y McDonald",
			pt: "Ilhas Heard e McDonald",
			fa: "هرد و جزایر مک‌دونالد",
	...
	},
	{
		...
		slug: "democratic-people-s-republic-of-korea",
		translations: {
			de: "Nordkorea",
...
// publish time — folded in from the former graphics-atlas-topojson repo, see
// #31). The fetchers read them from this package's OWN version-pinned, immutable
// jsDelivr URL, so the geometry can never drift from the client asking for it —
// it's literally the same published version. (Only resolves once a version
// carrying the `topojson/` assets is published to npm.) Consumers who want the
// files locally / tree-shaken can import them directly, e.g.
...
// version so URLs/classes don't drift. Codes are lowercase. (see #30)
...
export { MetadataClient as default };
