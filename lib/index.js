...
// TopoJSON assets live in a separate, independently-versioned repo/package
// (reuters-graphics/graphics-atlas-topojson), served over the jsDelivr CDN at
// a pinned version so geometry can't drift from the client. (see #31)
//
// PRE-PUBLISH: served from the public GitHub repo via jsDelivr's /gh mode so
// the fetchers are testable before the npm package is published. Once it's on
// npm, switch FETCH_BASE to:
//   `https://cdn.jsdelivr.net/npm/@reuters-graphics/graphics-atlas-topojson@${TOPOJSON_VERSION}`
const TOPOJSON_REPO = 'reuters-graphics/graphics-atlas-topojson';
const TOPOJSON_VERSION = 'v0.1.0';
const FETCH_BASE = `https://cdn.jsdelivr.net/gh/${TOPOJSON_REPO}@${TOPOJSON_VERSION}`;
